...
import sherpa_client

# -- Project information -----------------------------------------------------

project = "sherpa_client"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = sherpa_client.__version__
release = sherpa_client.__version__
...
apidoc_module_dir = os.path.dirname(sherpa_client.__file__)
