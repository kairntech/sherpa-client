...
def _get_kwargs(
    ...
    *,
    ...
    search_type: Union[Unset, SearchSegmentsSearchType] = SearchSegmentsSearchType.TEXT,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_name}/segments/_search".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        search_type (Union[Unset, SearchSegmentsSearchType]):  Default:
