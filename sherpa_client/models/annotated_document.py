...
if TYPE_CHECKING:
    ...
    from ..models.annotated_document_boundaries import AnnotatedDocumentBoundaries
...
class AnnotatedDocument:
    ...
    Attributes:
        ...
        boundaries (Union[Unset, AnnotatedDocumentBoundaries]): text boundaries of the document, as a map of boundary
    ...
    boundaries: Union[Unset, "AnnotatedDocumentBoundaries"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        boundaries: Union[Unset, AnnotatedDocumentBoundaries]
        if isinstance(_boundaries, Unset):
            boundaries = UNSET
        else:
            boundaries = AnnotatedDocumentBoundaries.from_dict(_boundaries)
